...
def design_organoid_sl_experiment(
    ...
    log.append("")
    log.append("4 | READOUTS (3D-appropriate)")
    ...
    log.append("")
    log.append("6 | FALSIFICATION CRITERIA (pre-specified)")
    ...
    log.append("")
    log.append("7 | WHAT THIS EXPERIMENT CANNOT SETTLE")
